...
| 2 | Максимизация code coverage |
| 3 | Unicode, спецсимволы, escape-последовательности |
| 4 | Malformed входы, синтаксические ошибки |
...
После генерации corpus его можно использовать для фаззинга с утилитой [go-118-fuzz-build](https://github.com/AdamKorcz/go-118-fuzz-build):
```bash
